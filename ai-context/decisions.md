...
подразумевается: за весь блок на телефоне не запускалось НИЧЕГО из того, что он построил.** Телефон в
блоке был — раунд измерений Task 13/13b (ниже) выполнялся на SM-A325F, — но он измерял **премиссы
Android**, а не продукт. Ни один из пяти действующих инструментов, ни карточка согласия первого
`CONFIRM`-инструмента, ни один из шести турецких триггеров на устройстве не наблюдались. Это обычный
