 ...
 * table, and the Stage-2 S2-2 `aliases` table.
 *
 * - `version = 3`, `exportSchema = true` → schema JSON committed under `data/repository/schemas/`.
 *   `1.json` is the frozen historical 3-entity shape; `2.json` (Task 9) adds `resolution_preferences`
 *   via `Migration1To2`; `3.json` adds `aliases` via `Migration2To3`.
 * - All five tables are recreatable learning/cache tables. `fallbackToDestructiveMigration` may be
